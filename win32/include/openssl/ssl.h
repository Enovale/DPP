...
/* Maximum length of the application-controlled segment of a a TLSv1.3 ***REMOVED*** */
...
# endif
void SSL_CTX_set_***REMOVED***_generate_cb(SSL_CTX *ctx,
                                    int (*app_gen_***REMOVED***_cb) (SSL *ssl,
                                                              unsigned char
                                                              ****REMOVED***,
                                                              unsigned int
                                                              ****REMOVED***_len));
void SSL_CTX_set_***REMOVED***_verify_cb(SSL_CTX *ctx,
                                  int (*app_verify_***REMOVED***_cb) (SSL *ssl,
                                                               const unsigned
                                                               char ****REMOVED***,
                                                               unsigned int
                                                               ***REMOVED***_len));

void SSL_CTX_set_stateless_***REMOVED***_generate_cb(
    SSL_CTX *ctx,
    int (*gen_stateless_***REMOVED***_cb) (SSL *ssl,
                                    unsigned char ****REMOVED***,
                                    size_t ****REMOVED***_len));
void SSL_CTX_set_stateless_***REMOVED***_verify_cb(
    SSL_CTX *ctx,
    int (*verify_stateless_***REMOVED***_cb) (SSL *ssl,
